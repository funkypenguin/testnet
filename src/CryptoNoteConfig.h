...
const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX                   = 20;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 18000;
...
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V2_UPGRADE_HEIGHT  = 15880;
...
const char     CRYPTONOTE_NAME[]                             = "TestVico";
